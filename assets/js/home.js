...
(function ($) {
  jQuery(document).ready(function () {
    ...
    var skillCardsHolder = document.getElementById("primary-skills");
    if (skillCardsHolder != null && skillCardsHolder.children.length != 0) {
      skillCards = $(".filtr-skills").filterizr({ layout: 'sameWidth', setupControls: false });
    }
